    ...
    <div class="tp-banner-container rs-youplay">
      <div class="tp-banner">
        <ul>
          ...
          <li>
            <!-- MAIN IMAGE -->
            <img alt="" data-lazyload="images/racing/img_1/1.jpg" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
          </li>
      ...
      <div class="col-md-9 col-md-push-3">
        ...
        <article>
          ...
          <div class="description">
            <p>
              Grid 2 is a racing video game developed and published by Codemasters for Microsoft Windows, PlayStation 3 and Xbox 360. The title: "Grid" stands for: "Grand Race International Drifting" t is the eighth game in the TOCA series. On 25 September 2014, Feral Interactive released the Reloaded Edition for OS X. The game includes numerous real world locations and cities such as Paris. It also includes motor vehicles spanning four decades. In addition, it includes a new handling system that developer Codemasters has dubbed 'TrueFeel', which aims to hit a sweet spot between realism and accessibility. Races do not include a first person cockpit view. The popular gamemode "Drift" was shown in a gameplay preview by Codemasters. Drivers are given certain cars before some race modes, and can unlock others through other vehicle challenges. Car liveries can be customised by the player, using preset graphic designs adapted with colours or varying shades. World Series Racing (WSR) is a highly competitive racing</p>
              <p>event that races on various tracks on various continents around the globe. It also features a mode called "LiveRoutes" where the circuit track dynamically changes with no track map. It features race types including Race, Time Attack, Drift, Eliminator, Checkpoint, Touge, and Vehicle Challenges. A player assumes the role of a new driver who is enlisted by Patrick Callahan, an investor, to help launch the WSR by challenging drivers of racing clubs. Winning races against drivers in established clubs in North America, Europe and Asia gains more fans for the series, and leads to drivers from those clubs agreeing to join the WSR.
          ...
          <div class="youplay-carousel gallery-popup">
            <a class="angled-img" href="https://www.youtube.com/watch?v=cRsNc-rB-Vs">
              <div class="img">
                <img src="images/racing/2.jpg" alt="">
              </div>
              <i class="fa fa-play icon"></i>
            </a>
            <a class="angled-img" href="images/racing/img_1/a_l.jpg">
              <div class="img">
                <img src="images/racing/img_1/a_s.jpg" alt="">
              </div>
              <i class="fa fa-search-plus icon"></i>
            </a>
            <a class="angled-img" href="images/racing/img_1/b_l.jpg">
              <div class="img">
                <img src="images/racing/img_1/b_s.jpg" alt="">
              </div>
              <i class="fa fa-search-plus icon"></i>
            </a>
            <a class="angled-img" href="images/racing/img_1/c_l.jpg">
              <div class="img">
                <img src="images/racing/img_1/c_s.jpg" alt="">
              </div>
              <i class="fa fa-search-plus icon"></i>
            </a>
            <a class="angled-img" href="images/racing/img_1/d_l.jpg">
              <div class="img">
                <img src="images/racing/img_1/d_s.jpg" alt="">
              </div>
              <i class="fa fa-search-plus icon"></i>
            </a>
            <a class="angled-img" href="images/racing/img_1/e_l.jpg">
              <div class="img">
                <img src="images/racing/img_1/e_s.jpg" alt="">
              </div>
              <i class="fa fa-search-plus icon"></i>
            </a>
          </div>
          ...
          <div class="panel-group youplay-accordion" id="accordion" role="tablist" aria-multiselectable="true">
            <div class="panel panel-default">
              ...
              <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                <div class="panel-body">
                  <div>
                    <strong>OS:</strong>  Windows XP / 7 / 8.1 - (32-Bit)
                  </div>
                  <div>
                    <strong>Processor:</strong> Intel Core 2 Duo E6600 2.4GHz / AMD Athlon 64 X2 Dual Core 5400+
                  </div>
                  <div>
                    <strong>Memory:</strong> 2 GB RAM
                  </div>
                  <div>
                    <strong>Graphics:</strong> NVIDIA GeForce 8600 GT 512MB GDDR3 / AMD Radeon HD 2600 XT
                  </div>
                  <div>
                    <strong>DirectX:</strong> DirectX 11
                  </div>
                  <div>
                    <strong>Hard Drive:</strong> 15 GB available space
                  </div>
                </div>
              </div>
            </div>
            <div class="panel panel-default">
              ...
              <div id="collapseTwo" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingTwo">
                <div class="panel-body">
                  <div>
                    <strong>OS:</strong> Windows 7 / 8.1 - (64-Bit)
                  </div>
                  <div>
                    <strong>Processor:</strong> Intel Core i7-920 Quad 2.67GHz / AMD FX-4350
                  </div>
                  <div>
                    <strong>Memory:</strong> 4 GB RAM
                  </div>
                  <div>
                    <strong>Graphics:</strong> Nvidia GeForce GT 740 or AMD HD6000 Series
                  </div>
                  <div>
                    <strong>DirectX:</strong> DirectX 11
                  </div>
