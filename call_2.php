    ...
    <div class="tp-banner-container rs-youplay">
      <div class="tp-banner">
        <ul>
          ...
          <li>
            <!-- MAIN IMAGE -->
            <img alt="" data-lazyload="images/shooter/img_3/1.jpg" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
          </li>
      ...
      <div class="col-md-9 col-md-push-3">
        ...
        <article>
          ...
          <div class="description">
            <p>
              Call of Duty: Modern Warfare 2 is a first-person shooter video game developed by Infinity Ward and published by Activision. The player can perform several actions, including jump, sprint, crouch, lay prone, and aim down their guns iron sights. When the player is shot by an enemy, blood will splatter their heads-up display (HUD), denoting that they have taken damage; if the player avoids gunfire by taking cover, then their health will recover.
            </p>
          </div>
          <!-- /Description -->
          ...
          <div class="youplay-carousel gallery-popup">
            <a class="angled-img" href="https://www.youtube.com/watch?v=P7vyLDEwF5I">
              <div class="img">
                <img src="images/shooter/4.jpg" alt="">
              </div>
              <i class="fa fa-play icon"></i>
            </a>
            <a class="angled-img" href="images/shooter/img_3/a_l.jpg">
              <div class="img">
                <img src="images/shooter/img_3/a_s.jpg" alt="">
              </div>
              <i class="fa fa-search-plus icon"></i>
            </a>
            <a class="angled-img" href="images/shooter/img_3/b_l.jpg">
              <div class="img">
                <img src="images/shooter/img_3/b_s.jpg" alt="">
              </div>
              <i class="fa fa-search-plus icon"></i>
            </a>
            <a class="angled-img" href="images/shooter/img_3/c_l.jpg">
              <div class="img">
                <img src="images/shooter/img_3/c_s.jpg" alt="">
              </div>
              <i class="fa fa-search-plus icon"></i>
            </a>
            <a class="angled-img" href="images/shooter/img_3/d_l.jpg">
              <div class="img">
                <img src="images/shooter/img_3/d_s.jpg" alt="">
              </div>
              <i class="fa fa-search-plus icon"></i>
            </a>
            <a class="angled-img" href="images/shooter/img_3/e_l.jpg">
              <div class="img">
                <img src="images/shooter/img_3/e_s.jpg" alt="">
              </div>
              <i class="fa fa-search-plus icon"></i>
            </a>
          </div>
          ...
          <div class="panel-group youplay-accordion" id="accordion" role="tablist" aria-multiselectable="true">
            <div class="panel panel-default">
              ...
              <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                <div class="panel-body">
                  <div>
                    <strong>OS:</strong> Microsoft Windows XP, Windows Vista and Windows 7
                  </div>
                  <div>
                    <strong>Processor:</strong> Intel Pentium 4 3.2 GHz or AMD Athlon 64 3200+ processor or better supported
                  </div>
                  <div>
                    <strong>Memory:</strong>  1 GB RAM
                  </div>
                  <div>
                    <strong>Graphics:</strong> 256 MB NVIDIA GeForce 6600 GT or better
                  </div>
                  <div>
                    <strong>DirectX:</strong> DirectX 9.0C or later
                  </div>
                  <div>
                    <strong>Hard Drive:</strong> 12 GB free hard drive space
                  </div>
                </div>
              </div>
            </div>
            <div class="panel panel-default">
              ...
              <div id="collapseTwo" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingTwo">
                <div class="panel-body">
                  <div>
                    <strong>OS:</strong> Windows XP, Windows Vista & Windows 7
                  </div>
                  <div>
                    <strong>Processor:</strong> Intel Core 2 Duo E6600 2.4GHz
                  </div>
                  <div>
                    <strong>Memory:</strong> 2 GB RAM
                  </div>
                  <div>
                    <strong>Graphics:</strong> NVIDIA GeForce 8800 GS or better
                  </div>
                  <div>
                    <strong>DirectX:</strong> DirectX 9.0C or late
                  </div>
                  <div>
                    <strong>Hard Drive:</strong> 12 GB free hard drive space
                  </div>
