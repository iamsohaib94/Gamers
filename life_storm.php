    ...
    <div class="tp-banner-container rs-youplay">
      <div class="tp-banner">
        <ul>
          ...
          <li>
            <!-- MAIN IMAGE -->
            <img alt="" data-lazyload="images/adventure/img_2/1.jpg" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
          </li>
      ...
      <div class="col-md-9 col-md-push-3">
        ...
        <article>
          ...
          <div class="youplay-carousel gallery-popup">
            <a class="angled-img" href="https://www.youtube.com/watch?v=bVq3JMcA9qQ">
              <div class="img">
                <img src="images/adventure/3.jpg" alt="">
              </div>
              <i class="fa fa-play icon"></i>
            </a>
            <a class="angled-img" href="images/adventure/img_2/a_l.jpg">
              <div class="img">
                <img src="images/adventure/img_2/a_s.jpg" alt="">
              </div>
              <i class="fa fa-search-plus icon"></i>
            </a>
            <a class="angled-img" href="images/adventure/img_2/b_l.jpg">
              <div class="img">
                <img src="images/adventure/img_2/b_s.jpg" alt="">
              </div>
              <i class="fa fa-search-plus icon"></i>
            </a>
            <a class="angled-img" href="images/adventure/img_2/c_l.jpg">
              <div class="img">
                <img src="images/adventure/img_2/c_s.jpg" alt="">
              </div>
              <i class="fa fa-search-plus icon"></i>
            </a>
            <a class="angled-img" href="images/adventure/img_2/d_l.png">
              <div class="img">
                <img src="images/adventure/img_2/d_s.png" alt="">
              </div>
              <i class="fa fa-search-plus icon"></i>
            </a>
            <a class="angled-img" href="images/adventure/img_2/e_l.jpg">
              <div class="img">
                <img src="images/adventure/img_2/e_s.jpg" alt="">
              </div>
              <i class="fa fa-search-plus icon"></i>
            </a>
          </div>
            ...
            <div class="panel panel-default">
              ...
              <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                <div class="panel-body">
                  <div>
                    <strong>OS:</strong> Windows 7/8.1/10 64-bit
                  </div>
                  <div>
                    <strong>Processor:</strong> Intel Core i3-6100 3.7GHz / AMD Athlon X4 845
                  </div>
                  <div>
                    <strong>Memory:</strong> 6 GB RAM
                  </div>
                  <div>
                    <strong>Graphics:</strong> NVIDIA GeForce GTX 1050 or AMD Radeon RX 460 2GB
                  </div>
                  <div>
                    <strong>DirectX:</strong> DirectX 11
                  </div>
                  <div>
                    <strong>Hard Drive:</strong> 14 GB available space
                  </div>
                </div>
              </div>
            </div>
